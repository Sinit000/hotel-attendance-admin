  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: standardAppBar(context,
          "${AppLocalizations.of(context)!.translate("edit_leave_type")!}"),
                          ...
                          standardBtn(
                              ...
                              onTap: () {
                                if (_formKey!.currentState!.validate()) {
                                  ...
                                  if (_perentCtrl.text != "") {
                                    if (widget.leaveTypeModel.parentId != "0") {
                                      if (widget.leaveTypeModel.name !=
                                          _perentCtrl.text) {
                                        LeaveTypeModel leavetype =
                                            _leaveTypeBloc.leavetype.firstWhere(
                                                (e) =>
                                                    e.name == _perentCtrl.text);
                                        parentId = leavetype.id;
                                      } else {
                                        parentId =
                                            widget.leaveTypeModel.parentId!;
                                      }
                                    }
                                  }
                                  typeBloc.add(UpdateLeaveTypeStarted(
