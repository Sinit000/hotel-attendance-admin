...
class EmployeeOvertimeReport extends StatefulWidget {
  final List<EmployeeModel> employeeModel;
  const EmployeeOvertimeReport({required this.employeeModel});

  @override
  State<EmployeeOvertimeReport> createState() => _EmployeeOvertimeReportState();
}

class _EmployeeOvertimeReportState extends State<EmployeeOvertimeReport> {
  ReportBloc overtimeBloc = ReportBloc();
  ...
  void initState() {
    ...
    if (id == "0") {
      ...
      overtimeBloc.add(InitailizeOTEmployeeStarted(
        id: id.toString(),
        ...
        body: BlocConsumer(
            ...
            builder: (context, state) {
              ...
              if (state is InitailizingDailyReport) {
                ...
                return Column(
                  children: [
                    id == "0" || overtimeBloc.dateRange == null
                        ? Row(
                            children: [
                              Container(
                                ...
                                child: DropdownButton<String>(
                                  ...
                                  onChanged: (value) {
                                    if (value == "Custom") {
                                      ...
                                      if (id != "0") {
                                        overtimeBloc
                                            .add(InitailizeOTEmployeeStarted(
                                          id: id.toString(),
                                          dateRange: mydateRage,
                                          isSecond: false,
                                          isRefresh: false,
                    ...
                    overtimeBloc.dateRange == null
                        ...
                        : overtimeBloc.reportOTEmployee.length == 0
                            ...
                            : Expanded(
                                ...
                                onLoading: () {
                                  overtimeBloc.add(FetchOTEmployeeStarted(
                                      dateRange: mydateRage,
                                      id: id.toString()));
                                },
                                enablePullDown: true,
