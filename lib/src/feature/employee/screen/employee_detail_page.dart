...
//         appBar: standardAppBar(context, "${AppLocalizations.of(context)!.translate("employee_detail")!}"),
//         body: BlocBuilder(
//             bloc: employeeBloc,
...
//                                   ),
//                                   SizedBox(height: 5),
//                               employeeBloc.employeeModel!.employeeModel.meritalStatus == null
//                                   ? Container()
//                                   : Row(
//                                       crossAxisAlignment:
//                                           CrossAxisAlignment.start,
...
//                                               .bodyText1,
//                                         ),
//                                         employeeBloc.employeeModel!.employeeModel.meritalStatus ==
//                                                 null
//                                             ? Container()
//                                             : Expanded(
//                                                 child: Text(
//                                                   "${employeeBloc.employeeModel!.employeeModel.m}",
//                                                   style: Theme.of(context)
//                                                       .textTheme
//                                                       .bodyText1,
//                                                 ),
